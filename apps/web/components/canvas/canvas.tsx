...
export function Canvas() {
  ...
  return (
    <div
      className={cn(
        "relative top-0 right-0 z-50 h-full w-3/5 overflow-x-scroll border-l bg-background shadow-[0_0_18px_rgba(0,0,0,0.12)] dark:shadow-[0_0_18px_rgba(0,0,0,0.48)]",
